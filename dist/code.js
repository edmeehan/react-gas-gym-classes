...
function test() {
    ...
    var getRowsInSheetByColumn = function(sheetName, col, data) {
        var ignoreCase = !(arguments.length > 3 && arguments[3] !== undefined) || arguments[3], rows = retrieveSheetRows(sheetName);
        return rows.shift(), rows.filter(function(item) {
        ...
        var ignoreCase = !(arguments.length > 2 && arguments[2] !== undefined) || arguments[2], rows = retrieveSheetRows(sheetName);
        return rows.shift(), rows.filter(function(item) {
    ...
    }, retrieveSheetRows = function(sheetName) {
    ...
    __webpack_require__.r(__webpack_exports__), function(global) {
        ...
        global.doGet = _app_routes_js__WEBPACK_IMPORTED_MODULE_0__["a"], global.getRowsInSheetByColumn = _app_js__WEBPACK_IMPORTED_MODULE_1__["b"], 
        global.getRowsInSheet = _app_js__WEBPACK_IMPORTED_MODULE_1__["a"], global.test = _app_js__WEBPACK_IMPORTED_MODULE_1__["c"];
